...
import esilv.sdp.java.project.SNCFProperties;
...
public class ConnectAPI {
    ...
    public ConnectAPI(String api_url) {
    ...
    public String executeGet(String url) {
        ...
        try {
            ...
            // Add authentication
            httpget.addHeader(BasicScheme.authenticate(new UsernamePasswordCredentials("f806224a-4304-4ed5-857a-ebdcfe4c075f", this.password), "UTF-8", false));
            // Execute the request
